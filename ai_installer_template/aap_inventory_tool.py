...
class InventoryGenerator(InventoryProcessor):
    ...
    def generate_inventory(self, output_path: str, host: str = None, **kwargs) -> bool:
        ...
        if self.platform == 'containerized' and self.topology == 'growth':
            return self._generate_containerized_growth(output_path, host, **kwargs)
        elif self.platform == 'containerized' and self.topology == 'enterprise':
            return self._generate_containerized_enterprise(output_path, **kwargs)
        elif self.platform == 'rpm' and self.topology == 'growth':
            return self._generate_rpm_growth(output_path, **kwargs)
        elif self.platform == 'rpm' and self.topology == 'enterprise':
            return self._generate_rpm_enterprise(output_path, **kwargs)
        else:
    ...
    def _generate_containerized_growth(self, output_path: str, host: str = None, **kwargs) -> bool:
...
"""
        ...
        try:
            ...
            self.errors.append(f"Error writing inventory file: {e}")
            # return False
            return None

    def _generate_containerized_enterprise(self, output_path: str, **kwargs) -> bool:
...
"""
    ...
    def _generate_rpm_growth(self, output_path: str, **kwargs) -> bool:
...
"""
    ...
    def _generate_rpm_enterprise(self, output_path: str, **kwargs) -> bool:
...
def generate_command(args):
    ...
    success = generator.generate_inventory(output_path, args.host, **kwargs)
